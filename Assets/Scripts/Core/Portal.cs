...
public class Portal : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        //transform.parent.GetComponent<PortalConnector>().ConnectPortal(this);
    }
    ...
    {
        if (viewTexture == null || refresh || viewTexture.width != Screen.width || viewTexture.height != Screen.height)
        {
            if (viewTexture != null)
            {
                viewTexture.Release();
    ...
    public void ConnectToPortal(Portal p)
    {
        linkedPortal = p;
        p.linkedPortal = this;
        refresh = true;
        ...
        /*if(p.transform.rotation == transform.rotation)
        {
